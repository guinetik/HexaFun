...
public class TodoAppDemo {
            ...
            if (todos.isEmpty()) {
                ...
                if (!incompleteTodos.isEmpty()) {
                    ...
                    for (int i = 0; i < incompleteTodos.size(); i++) {
                        ...
                        String createdAt = todo.getCreatedAt().format(DATE_FORMAT);
                        System.out.printf("%d. %s | %s | Created: %s%n", 
                                i + 1,
                                todo.getId().substring(0, 8), 
                                todo.getTitle(),
                                createdAt);
                        
                        // Show description if present
                        if (todo.getDescription() != null && !todo.getDescription().isEmpty()) {
                            System.out.printf("   Description: %s%n", todo.getDescription());
                        }
                    }
                }
                ...
                if (!completedTodos.isEmpty()) {
                    ...
                    for (int i = 0; i < completedTodos.size(); i++) {
                        ...
                        String completedAt = todo.getUpdatedAt().format(DATE_FORMAT);
        ...
        if (listResult.isSuccess()) {
            ...
            try {
                ...
                if (index >= 0 && index < incompleteTodos.size()) {
                    ...
                    Result<Todo> result = todoApp.completeTodo(new CompleteTodoInput(selectedTodo.getId()));
    ...
    private static void printTodoDetails(Todo todo) {
        ...
        System.out.println("Description: " + (todo.getDescription().isEmpty() ? "(None)" : todo.getDescription()));
        System.out.println("Status: " + (todo.isCompleted() ? "Completed" : "Not completed"));
        System.out.println("Created: " + todo.getCreatedAt().format(DATE_FORMAT));
        
        if (todo.isCompleted()) {
            System.out.println("Completed: " + todo.getUpdatedAt().format(DATE_FORMAT));
        }
    }
}
