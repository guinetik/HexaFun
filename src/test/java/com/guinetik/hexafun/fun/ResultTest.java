...
public class ResultTest {
    ...
    @Test
    void testObjectsRequireNonNullInConstructors() {
        // Success constructor should throw NullPointerException for null value
        assertThrows(NullPointerException.class, () -> Result.ok(null));
        
        // Failure constructor should throw NullPointerException for null error
